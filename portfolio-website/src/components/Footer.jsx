...
function Footer() {
  return (
    <footer className="border-t border-slate-200/80 py-10 dark:border-gold-500/50">
      <div className="mx-auto flex w-full max-w-6xl flex-col items-center justify-between gap-4 px-5 text-sm text-slate-600 md:flex-row md:px-8 dark:text-slate-400">
        ...
        <div className="flex items-center gap-4">
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="rounded-full border border-slate-300 p-2 transition duration-300 hover:-translate-y-0.5 hover:border-gold-500 hover:text-gold-600 dark:border-gold-500/50"
          >
            <FaLinkedin size={18} />
          </a>
          <a
