      ...
      <div className="mt-7 flex flex-wrap gap-3">
        ...
        {project.githubUrl && (
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="inline-flex items-center gap-2 rounded-lg border border-slate-300 px-4 py-2 text-sm font-semibold text-slate-800 transition duration-300 hover:-translate-y-0.5 hover:border-gold-500 hover:text-gold-600 dark:border-slate-700 dark:text-slate-100"
          >
            <FaCode size={12} />
            GitHub
          </a>
        ...
        {!hasLinks && (
          <span className="rounded-lg border border-slate-200 px-4 py-2 text-xs font-semibold text-slate-500 dark:border-slate-700 dark:text-slate-400">
            Links coming soon
          </span>
        )}
      </div>
